...
public class Levela12 extends Window
{
	...
	{	
		...
		particleSource0.rot = 0.0f;
		particleSource0.on = true;
		
		magnet0 = new Magnet(Magnet.TYPE_BLUE, 0.2f, 0.2f, 0.2f);
		magnet0.x = 0.2f;
		magnet0.y = -0.4f;
		...
		mirror0.x = 0.4f;
		mirror0.y = 0.8f;
		mirror0.rot = -3.141f / 4.0f;
		
		mirror1 = new Mirror(0.8f, 0.0f);
		mirror1.x = 0.4f;
		mirror1.y = -0.8f;
		mirror1.rot = 3.141f / 4.0f;
