...
public class Levela15 extends Window
{
	...
	{	
		...
		particleSource1.y = -0.6f;
		particleSource1.rot = 3* 3.141f / 4.0f;
		...
		mirror2 = new Mirror(0.8f, 0.0f);
		mirror2.x = -0.4f;
		mirror2.y = 0.4f;
		mirror2.rot = 3.141f / 2.0f;
	...
	{ 
		...
		particleSource0.AddMirror(mirror2);
		
		particleSource1.AddMirror(mirror0);
		particleSource1.AddMirror(mirror1);
		particleSource1.AddMirror(mirror2);
		...
		magnet0.AddMirrorCollision(mirror2);
		...
		magnet1.AddMirrorCollision(mirror1);
		magnet1.AddMirrorCollision(mirror2);
